...
export default function Fund() {
  ...
  const stats = [
    { icon: Target, label: t('fund_stat1_label'), value: t('fund_stat1_value') },
    { icon: Calendar, label: t('fund_stat2_label'), value: t('fund_stat2_value') },
    { icon: Clock, label: t('fund_stat3_label'), value: t('fund_stat3_value') },
    { icon: DollarSign, label: t('fund_stat4_label'), value: t('fund_stat4_value') },
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-3xl">
            ...
            <h1 className="animate-fade-in-up-delay-1 text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">
              Simplex Capital
              <span className="block text-tiffany">{t('fund_title')}</span>
            </h1>
          ...
          <FadeInSection>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-sm">
                <h3 className="text-sm font-semibold text-tiffany uppercase tracking-widest mb-8">{t('fund_structure_label')}</h3>
                <div className="space-y-6">
                  <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900">{t('fund_lp_title')}</h4>
                        <p className="text-sm text-gray-500">{t('fund_lp_desc')}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-2xl p-6 border-2 border-tiffany">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{t('fund_entity_desc')}</p>
                      </div>
                    </div>
                  </div>
                  <div className="flex justify-center">
                  ...
                  <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900">{t('fund_portfolio_title')}</h4>
                        <p className="text-sm text-gray-500">{t('fund_portfolio_desc')}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div>
                <h3 className="text-3xl font-bold text-gray-900 mb-6">{t('fund_structure_heading')}</h3>
                <div className="space-y-4 text-gray-600 leading-relaxed text-lg">
                  <p>{t('fund_structure_p1')}</p>
                  <p>{t('fund_structure_p2')}</p>
                  <p>{t('fund_structure_p3')}</p>
                </div>
              </div>
            </div>
          </FadeInSection>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeInSection>
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-10 sm:p-14">
              <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4">{t('fund_cta_title')}</h3>
              <p className="text-gray-400 text-lg mb-8">{t('fund_cta_desc')}</p>
              <Link to="/Contact">
                <Button size="lg" className="bg-tiffany hover:bg-tiffany-dark text-white rounded-full px-8">
                  {t('fund_cta_btn')} <ArrowRight className="w-4 h-4 ml-2" />
                </Button>
              </Link>
            </div>
          </FadeInSection>
