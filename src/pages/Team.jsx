...
const teamMembers = [
  {
    name: 'Anna Ermakova',
    title: 'Founder, Managing Partner, Simplex Capital',
  ...
  },
  {
    ...
    title: 'Founder, Partner, Simplex Capital',
    ...
    <div>
      ...
      <section className="relative min-h-[50vh] flex items-center">
        <div className="absolute inset-0 z-0">
          <img src="/images/team.jpg" alt="Team" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 text-center">
          <span className="inline-block text-tiffany text-sm font-semibold uppercase tracking-widest mb-4 animate-fade-in-up">Our Team</span>
                ...
                <div className="bg-gray-50 rounded-3xl p-8 sm:p-10">
                  <div className="flex items-start gap-6 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-tiffany font-semibold mt-1">{member.title}</p>
                    </div>
                  </div>
